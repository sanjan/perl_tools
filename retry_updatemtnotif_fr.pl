...
my $fr_inputspool_dir="/opt/HUB/NOTIF/updatemtnotif/inputspool";
my $fr_dbnotfound_dir="/opt/HUB/NOTIF/updatemtnotif/error/dbnotfound";
my $fr_dberror_dir="/opt/HUB/NOTIF/updatemtnotif/error/database";

my $uk_inputspool_dir="/opt/HUB/NOTIF/updatemtnotif_uk/inputspool";
my $uk_dbnotfound_dir="/opt/HUB/NOTIF/updatemtnotif_uk/error/dbnotfound";
my $uk_dberror_dir="/opt/HUB/NOTIF/updatemtnotif_uk/error/database";
